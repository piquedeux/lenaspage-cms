...
<head>
    ...
    <?php endif; ?>
    <!-- Static fallback favicon (served from assets/favicon/favicon.png) -->
    ...
    <link rel="stylesheet" href="<?php echo e(asset_url('assets/css/styles.css')); ?>">
...
<body class="<?php echo ($currentPage === 'home') ? 'is-home' : ''; ?>">
    <div class="folder-shell">
        <div class="folder-shell-scroll">
                <?php snippet('header', ['currentPage' => $currentPage, 'settings' => $settings, 'projectTitle' => ($projectTitle ?? '')]); ?>
    ...
    <div id="lightboxModal" class="lightbox-modal">
        <div class="lightbox-content">
            ...
            <div id="lightboxCaption" class="lightbox-caption" aria-hidden="true"></div>
    ...
    <script src="<?php echo e(asset_url('assets/js/projects-grid.js')); ?>"></script>
    <script src="<?php echo e(asset_url('assets/js/lightbox.js')); ?>"></script>
    <script src="<?php echo e(asset_url('assets/js/project-gallery.js')); ?>"></script>
    <script src="<?php echo e(asset_url('assets/js/project-thumbnail-gallery.js')); ?>"></script>
    <script src="<?php echo e(asset_url('assets/js/footer-behavior.js')); ?>"></script>
</body>
</html>
